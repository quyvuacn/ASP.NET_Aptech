...
namespace ShopASP.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BrandId,CategoryId,Description,Price,Weight,Sku")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BrandId,CategoryId,Description,Price,Weight,Sku")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
